...
\usepackage{varwidth}
\usepackage{pdfpages} %% Insertar portada
...
%%% Resumen %%%
\section*{Resumen}
\subfile{sections/0-prev/020-resumen.tex}
\newpage

%%% Abstract %%%
\section*{Abstract}
\subfile{sections/0-prev/020-abstract.tex}
\newpage
...
\subfile{sections/2-antecedentes-marco-tecnologico/270-iac.tex}
...
\subfile{sections/4-solucion-propuesta/400-solucion-propuesta.tex}
...
\subfile{sections/5-resultados/514-prueba-de-concepto.tex}
